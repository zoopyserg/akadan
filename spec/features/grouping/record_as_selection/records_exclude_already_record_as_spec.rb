...
RSpec.feature "RecordsIndices", type: :feature do
  ...
  it do
    expect_dropdown_not_to_contain_option('.add_existing_record_a_selection_section', 'Public Record 1')
    expect_dropdown_to_contain_option('.add_existing_record_a_selection_section', 'Public Record 2')
    expect_dropdown_to_contain_option('.add_existing_record_a_selection_section', 'Private Record 1')
