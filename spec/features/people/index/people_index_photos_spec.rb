...
RSpec.feature "People Index Photos", type: :feature do
  let!(:user1) do
  ...
  context 'not signed in' do
    ...
    it do
      within '#peopleList' do
        ...
        expect(page).to have_css "img[src*='friend_request_sent_to_him.jpg']"
        ...
        expect(page).to have_css "img[src*='blacklisted.jpg']"
        expect(page).to have_css "img[src*='blacklisted_m_e.jpg']"
      end
    end
  end
