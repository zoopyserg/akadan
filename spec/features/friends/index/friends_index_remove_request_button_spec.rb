...
RSpec.feature "Friends Index Reject Friend Request", type: :feature do
  let!(:user1) do
  ...
  context 'signed in' do
    context 'I sign in' do
      ...
      it { expect(page).to have_no_css "[href='#{reject_friend_friend_requests_path(friend_id: user1.id)}']" }
      it { expect(page).to have_no_css "[href='#{reject_friend_friend_requests_path(friend_id: stranger.id)}']" }
      it { expect(page).to have_no_css "[href='#{reject_friend_friend_requests_path(friend_id: stranger_protected.id)}']" }
      it { expect(page).to have_no_css "[href='#{reject_friend_friend_requests_path(friend_id: friend.id)}']" }
      it { expect(page).to have_no_css "[href='#{reject_friend_friend_requests_path(friend_id: friend_private.id)}']" }
      it { expect(page).to have_no_css "[href='#{reject_friend_friend_requests_path(friend_id: friend_request_sent_to_him.id)}']" }
      it { expect(page).to have_no_css "[href='#{reject_friend_friend_requests_path(friend_id: friend_request_sent_to_him_private.id)}']" }
      it { expect(page).to have_css "[href='#{reject_friend_friend_requests_path(friend_id: friend_request_sent_to_me.id)}']" }
      it { expect(page).to have_css "[href='#{reject_friend_friend_requests_path(friend_id: friend_request_sent_to_me_private.id)}']" }
      it { expect(page).to have_no_css "[href='#{reject_friend_friend_requests_path(friend_id: blacklisted.id)}']" }
      it { expect(page).to have_no_css "[href='#{reject_friend_friend_requests_path(friend_id: blacklisted_me.id)}']" }

      describe 'accepting a friend' do
        it { expect{ find("[href='#{reject_friend_friend_requests_path(friend_id: friend_request_sent_to_me.id)}']").click }.to change{ user1.friends.count }.by(0) }
        it { expect{ find("[href='#{reject_friend_friend_requests_path(friend_id: friend_request_sent_to_me.id)}']").click }.to change{ User.mutual_friends(user1).count }.by(0) }
        it { expect{ find("[href='#{reject_friend_friend_requests_path(friend_id: friend_request_sent_to_me.id)}']").click }.to change{ User.mutual_friends(friend_request_sent_to_me).count }.by(0) }
        it { expect{ find("[href='#{reject_friend_friend_requests_path(friend_id: friend_request_sent_to_me.id)}']").click }.to change{ User.who_thinks_they_are_friends_of(user1).count }.by(-1) }

        describe 'changes in friends list' do
          before { find("[href='#{reject_friend_friend_requests_path(friend_id: friend_request_sent_to_me.id)}']").click }

          it { expect(current_path).to eq friends_path }
          it { expect(page).to have_no_content 'Incoming Friend', exact: true }
          it { expect(page).to have_no_css "[href='#{reject_friend_friend_requests_path(friend_id: friend_request_sent_to_me.id)}']" }
        end
      end
    end
    ...
    context 'stranger@gmail.com signs in' do
      ...
      it { expect(page).to have_no_css "[href='#{reject_friend_friend_requests_path(friend_id: friend_request_sent_to_him_private.id)}']" }
      it { expect(page).to have_no_css "[href='#{reject_friend_friend_requests_path(friend_id: friend_request_sent_to_me.id)}']" }
      it { expect(page).to have_no_css "[href='#{reject_friend_friend_requests_path(friend_id: friend_request_sent_to_me_private.id)}']" }
      it { expect(page).to have_no_css "[href='#{reject_friend_friend_requests_path(friend_id: blacklisted.id)}']" }
      it { expect(page).to have_no_css "[href='#{reject_friend_friend_requests_path(friend_id: blacklisted_me.id)}']" }
    end
    ...
    context 'friend_request_sent_to_him@gmail.com signs in' do
      ...
      it { expect(page).to have_css "[href='#{reject_friend_friend_requests_path(friend_id: user1.id)}']" }
      it { expect(page).to have_no_css "[href='#{reject_friend_friend_requests_path(friend_id: stranger.id)}']" }
      it { expect(page).to have_no_css "[href='#{reject_friend_friend_requests_path(friend_id: stranger_protected.id)}']" }
      it { expect(page).to have_no_css "[href='#{reject_friend_friend_requests_path(friend_id: friend.id)}']" }
      it { expect(page).to have_no_css "[href='#{reject_friend_friend_requests_path(friend_id: friend_private.id)}']" }
