...
RSpec.feature "Profile Show Message Button", type: :feature do
  let!(:user1) do
  ...
  context 'signed in' do
    context 'I sign in' do
      ...
      context 'visit stranger page' do
        ...
        it { expect(page).to have_css "[href='#{person_conversation_starts_path(person_id: stranger.id)}']" }
      end
      ...
      context 'visit friend_request_sent_to_him page' do
        ...
        it { expect(page).to have_css "[href='#{person_conversation_starts_path(person_id: friend_request_sent_to_him.id)}']" }
      end
    ...
    context 'stranger@gmail.com signs in' do
      ...
      context 'visit blacklisted_me page' do
        ...
        it { expect(page).to have_css "[href='#{person_conversation_starts_path(person_id: blacklisted_me.id)}']" }
      end
