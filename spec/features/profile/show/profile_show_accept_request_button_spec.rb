...
RSpec.feature "Profile Show Accept Request Button", type: :feature do
  let!(:user1) do
  ...
  context 'not signed in' do
    ...
    context 'looking at stranger_protected profile' do
    ...
    context 'looking at friend_request_sent_to_him profile' do
    ...
    context 'looking at friend_request_sent_to_him_private profile' do
    ...
    context 'looking at friend_request_sent_to_me profile' do
    ...
    context 'looking at friend_request_sent_to_me_private profile' do
    ...
    context 'looking at blacklisted profile' do
    ...
    context 'looking at blacklisted_me profile' do
  ...
  context 'signed in' do
    context 'I sign in' do
      ...
      context 'looking at friend_request_sent_to_me_private profile' do
        ...
        it { expect(page).to have_css "[href='#{accept_friend_friend_requests_path(friend_id: friend_request_sent_to_me_private.id)}']" }
      end
