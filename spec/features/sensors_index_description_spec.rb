...
RSpec.feature "Sensor Index Description", type: :feature do
  ...
  let!(:public_sensor) { create :sensor, description: 'Public Description', user: user1, is_public: true }
  let!(:private_sensor) { create :sensor, description: 'Private Description', user: user2, is_public: false }
