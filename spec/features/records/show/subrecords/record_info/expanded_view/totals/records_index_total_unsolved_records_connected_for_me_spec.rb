...
RSpec.feature "Unsolved Tree Records Counter for me", :records_index, type: :feature do
  ...
  context 'not signed in' do
    ...
    it { expect(page).to have_no_content 'My unsolved records in tree' }
  end
  ...
  context 'signed in as user1 (owner)' do
    ...
    context 'two destructive subrecords, one solved' do
      ...
      it { expect(page).to have_content 'My unsolved records in tree: 4' } # because in the tree the solution is itself "unsolved"
    end
