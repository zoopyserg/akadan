...
RSpec.feature "Unsolved Tree Records Counter", :records_index, type: :feature do
  ...
  context 'single unsolved record' do
    ...
    it { expect(page).to have_content 'Unsolved records in tree: 2' }
  end
  ...
  context 'two destructive subrecords, one solved' do
    ...
    it { expect(page).to have_content 'Unsolved records in tree: 4' } # because in the tree the solution is itself "unsolved"
  end
