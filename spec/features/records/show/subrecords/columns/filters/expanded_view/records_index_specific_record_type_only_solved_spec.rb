    ...
    describe 'raw URL visit' do
      context 'record type 1' do
        context 'not signed in' do
          before { visit "/records/#{main_record1.id}?only_solved=true&record_type_id=#{record_type1.id}" }
        ...
        context 'signed in' do
          before do
            ...
            visit "/records/#{main_record1.id}?only_solved=true&record_type_id=#{record_type1.id}"
          end
