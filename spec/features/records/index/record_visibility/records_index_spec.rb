...
RSpec.feature "RecordsIndices", type: :feature do
  ...
  let!(:public_record) { create :record, :with_dot, name: 'Public Record', user: user, is_public: true }
  let!(:private_record) { create :record, :with_dot, name: 'Private Record', user: user, is_public: false }
