...
RSpec.feature "Decising which records to show", :records_index, :focus, type: :feature do
  ...
  context 'showing only solved records' do
    ...
    context 'not signed in' do
      before { visit only_solved_records_path }
    ...
    context 'signed in' do
      before do
        ...
        sign_in('user2@gmail.com', 'rediculouslycomplexpassword54321')
        visit only_solved_records_path
      end
  ...
  context 'showing only unsolved records' do
    ...
    context 'not signed in' do
      before { visit only_unsolved_records_path }
    ...
    context 'signed in' do
      before do
        visit connection_types_path
        sign_in('user2@gmail.com', 'rediculouslycomplexpassword54321')
        visit only_unsolved_records_path
      end
  ...
  context 'showing only records of specific type' do
    ...
    context 'record type 1' do
      context 'not signed in' do
        before { visit only_record_type_records_path(record_type1) }
      ...
      context 'signed in' do
        before do
          visit connection_types_path
          sign_in('user2@gmail.com', 'rediculouslycomplexpassword54321')
          visit only_record_type_records_path(record_type1)
        end
    ...
    context 'record type 2' do
      context 'not signed in' do
        before { visit only_record_type_records_path(record_type2) }
      ...
      context 'signed in' do
        before do
          visit connection_types_path
          sign_in('user2@gmail.com', 'rediculouslycomplexpassword54321')
          visit only_record_type_records_path(record_type2)
        end
    ...
    context 'record type invalid' do
      context 'not signed in' do
        before { visit only_record_type_records_path(999999) }
      ...
      context 'signed in' do
        before do
          visit connection_types_path
          sign_in('user2@gmail.com', 'rediculouslycomplexpassword54321')
          visit only_record_type_records_path(999999)
        end
