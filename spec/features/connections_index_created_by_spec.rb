...
RSpec.feature "ConnectionsIndex Created By", type: :feature do
  ...
  let!(:public_connection) { create :connection, name: 'Public Connection', user: user1, is_public: true }
  let!(:private_connection) { create :connection, name: 'Private Connection', user: user2, is_public: false }
