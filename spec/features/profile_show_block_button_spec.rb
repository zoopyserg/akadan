...
RSpec.feature "Profile Show Block Button", type: :feature do
  let!(:user1) do
  ...
  context 'signed in' do
    context 'I sign in' do
      ...
      context 'visiting stranger_protected page' do
        ...
        it { expect(page).to have_css "[href='#{blocked_user_blockings_path(blocked_user_id: stranger_protected.id)}']" }
      end
      ...
      context 'visiting friend_request_sent_to_him_private page' do
        ...
        it { expect(page).to have_css "[href='#{blocked_user_blockings_path(blocked_user_id: friend_request_sent_to_him_private.id)}']" }
      end
      ...
      context 'visiting friend_request_sent_to_me_private page' do
        ...
        it { expect(page).to have_css "[href='#{blocked_user_blockings_path(blocked_user_id: friend_request_sent_to_me_private.id)}']" }
      end
