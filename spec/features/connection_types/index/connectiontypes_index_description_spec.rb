...
RSpec.feature "Connection Types Index Description", type: :feature do
  ...
  let!(:public_connection_type) { create :connection_type, description: 'Public Description', user: user1, is_public: true }
  let!(:private_connection) { create :connection_type, description: 'Private Description', user: user2, is_public: false }
