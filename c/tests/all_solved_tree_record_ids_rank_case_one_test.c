...
void test_all_solved_tree_record_ids_rank_case_one(void) {
    ...
    sprintf(expectedOutput1, "%s: 1 : 4.200000 : 100.000000", rootRecordId1);
    sprintf(expectedOutput2, "%s: 1 : 4.400000 : 100.000000", rootRecordId2);
    sprintf(expectedOutput3, "%s: 0 : 4.200000 : 0.000000", solutionId1);
    sprintf(expectedOutput4, "%s: 0 : 4.400000 : 0.000000", solutionId2);
