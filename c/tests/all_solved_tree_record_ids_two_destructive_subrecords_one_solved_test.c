...
void test_all_solved_tree_record_ids_two_destructive_subrecords_one_solved() {
    ...
    sprintf(expectedOutput1, "%s: 0 : 12.000000", rootRecordId);
    sprintf(expectedOutput2, "%s: 1 : 12.000000", recordId1);
    sprintf(expectedOutput3, "%s: 0 : 12.000000", recordId2);
    sprintf(expectedOutput4, "%s: 0 : 12.000000", solutionId1);
