...
// (root)
// |---(1)
// |---(2) -- solved with (Solution 1)
// |---(3)
// |---(4) -- solved with (Solution 2)

int setup_all_solved_tree_record_ids(void) {
    common_cleanup();
    ...
    // Insert a record3
    char* recordColumns3[] = {"user_id", "name", "is_public", "record_type_id", "created_at", "updated_at", NULL};
    char* recordValues3[] = {userId, "Record 3", "FALSE", recordTypeId, "NOW()", "NOW()", NULL};
    recordId3 = common_insert("records", recordColumns3, recordValues3);
    if (!recordId3) {
        fprintf(stderr, "Setup failed: Unable to insert record.\n");
        free(userId); // Clean up the userId string
        free(recordTypeId);
    ...
    // Insert a record4
    char* recordColumns4[] = {"user_id", "name", "is_public", "record_type_id", "created_at", "updated_at", NULL};
    char* recordValues4[] = {userId, "Record 4", "FALSE", recordTypeId, "NOW()", "NOW()", NULL};
    recordId4 = common_insert("records", recordColumns4, recordValues4);
    if (!recordId4) {
        fprintf(stderr, "Setup failed: Unable to insert record.\n");
        free(userId); // Clean up the userId string
        free(recordTypeId);
    ...
    // Insert a connection between record2 and solution1
    char* connectionColumns[] = {"name", "user_id", "is_public", "record_a_id", "record_b_id", "connection_type_id", "created_at", "updated_at", NULL};
    char* connectionValues[] = {"Test Connection", userId, "TRUE", recordId2, solutionId1, connectionTypeId, "NOW()", "NOW()", NULL};
    ...
    // Insert a connection between record4 and solution2
    char* connectionColumns2[] = {"name", "user_id", "is_public", "record_a_id", "record_b_id", "connection_type_id", "created_at", "updated_at", NULL};
    char* connectionValues2[] = {"Test Connection 2", userId, "TRUE", recordId4, solutionId2, connectionTypeId, "NOW()", "NOW()", NULL};
    ...
    // Insert a connection between rootRecord and record3
    char* connectionColumns5[] = {"name", "user_id", "is_public", "record_a_id", "record_b_id", "connection_type_id", "created_at", "updated_at", NULL};
    char* connectionValues5[] = {"Test Connection 5", userId, "TRUE", rootRecordId, recordId3, connectionTypeId2, "NOW()", "NOW()", NULL};
    char* connectionId5 = common_insert("connections", connectionColumns5, connectionValues5);
    if (!connectionId5) {
        fprintf(stderr, "Setup failed: Unable to insert connection.\n");
        free(userId); // Clean up the userId string
        free(recordTypeId);
    ...
    // Insert a connection between rootRecord and record4
    char* connectionColumns6[] = {"name", "user_id", "is_public", "record_a_id", "record_b_id", "connection_type_id", "created_at", "updated_at", NULL};
    char* connectionValues6[] = {"Test Connection 6", userId, "TRUE", rootRecordId, recordId4, connectionTypeId2, "NOW()", "NOW()", NULL};
    char* connectionId6 = common_insert("connections", connectionColumns6, connectionValues6);
    if (!connectionId6) {
        fprintf(stderr, "Setup failed: Unable to insert connection.\n");
        free(userId); // Clean up the userId string
        free(recordTypeId);
...
void test_all_solved_tree_record_ids(void) {
    setup_all_solved_tree_record_ids();
    ...
    sprintf(expectedOutput1, "%s: 0 : 0 : 21.000000 : 50.000000 : %s,%s,%s,%s", rootRecordId, recordId1, recordId2, recordId3, recordId4);
    sprintf(expectedOutput2, "%s: 0 : 1 : 21.000000 : 0.000000 : %s", recordId1, rootRecordId);
    sprintf(expectedOutput3, "%s: 1 : 0 : 21.000000 : 100.000000 : %s,%s", recordId2, solutionId1, rootRecordId);
    sprintf(expectedOutput4, "%s: 0 : 1 : 21.000000 : 0.000000 : %s", recordId3, rootRecordId);
    sprintf(expectedOutput5, "%s: 1 : 0 : 21.000000 : 100.000000 : %s,%s", recordId4, solutionId2, rootRecordId);
    sprintf(expectedOutput6, "%s: 0 : 1 : 21.000000 : 0.000000 : %s,%s", solutionId1, recordId2, rootRecordId);
    sprintf(expectedOutput7, "%s: 0 : 1 : 21.000000 : 0.000000 : %s,%s", solutionId2, recordId4, rootRecordId);
