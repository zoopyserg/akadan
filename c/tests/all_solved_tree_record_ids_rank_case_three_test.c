...
void test_all_solved_tree_record_ids_rank_case_three(void) {
    ...
    sprintf(expectedOutput1, "%s: 1 : 0 : 9.600000 : 100.000000 : %s", rootRecordId1, recordId1);
    sprintf(expectedOutput2, "%s: 1 : 0 : 10.800000 : 100.000000 : %s", rootRecordId2, recordId2);
    sprintf(expectedOutput3, "%s: 1 : 0 : 9.600000 : 100.000000 : %s,%s", recordId1, solutionId1, rootRecordId1);
    sprintf(expectedOutput4, "%s: 1 : 0 : 10.800000 : 100.000000 : %s,%s", recordId2, solutionId2, rootRecordId2);
    sprintf(expectedOutput5, "%s: 0 : 1 : 9.600000 : 0.000000 : %s,%s", solutionId1, recordId1, rootRecordId1);
    sprintf(expectedOutput6, "%s: 0 : 1 : 10.800000 : 0.000000 : %s,%s", solutionId2, recordId2, rootRecordId2);
