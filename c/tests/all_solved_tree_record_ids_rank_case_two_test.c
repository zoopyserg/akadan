...
void test_all_solved_tree_record_ids_rank_case_two(void) {
    ...
    sprintf(expectedOutput2, "%s: 1 : 9.600000 : 100.000000", rootRecordId2);
    sprintf(expectedOutput3, "%s: 1 : 9.600000 : 100.000000", recordId1);
    sprintf(expectedOutput4, "%s: 0 : 4.200000 : 0.000000", solutionId1);
    sprintf(expectedOutput5, "%s: 0 : 9.600000 : 0.000000", solutionId2);
