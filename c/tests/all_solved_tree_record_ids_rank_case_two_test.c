...
//     char* connectionValues3[] = {"Test Connection", userId, "TRUE", rootRecordId1, solutionId1, connectionTypeId2, "NOW()", "NOW()", NULL};
...
//     char* connectionValues[] = {"Test Connection", userId, "TRUE", rootRecordId2, recordId1, connectionTypeId, "NOW()", "NOW()", NULL};
...
//     char* connectionValues2[] = {"Test Connection", userId, "TRUE", recordId1, solutionId2, connectionTypeId, "NOW()", "NOW()", NULL};
