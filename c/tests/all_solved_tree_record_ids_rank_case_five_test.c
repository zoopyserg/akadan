...
//     // Dot 1
//     char* dotValues3[] = {userId, rootRecordId2, rootRecordId2, "60", "Root Record 2 dot 1", "NOW()", "NOW()", NULL};
//     char* dotId2 = common_insert("dots", dotColumns, dotValues3);
//     if (!dotId2) { return -1; }
//     // Dot 2
//     char* dotValues4[] = {userId, rootRecordId2, rootRecordId2, "60", "Root Record 2 dot 2", "NOW()", "NOW()", NULL};
//     char* dotId3 = common_insert("dots", dotColumns, dotValues4);
//     if (!dotId3) { return -1; }
//
//     // Insert a record 1
...
//     char* dotValues4[] = {userId, recordId1, recordId1, "60", "Record 1 dot", "NOW()", "NOW()", NULL};
//     char* dotId3 = common_insert("dots", dotColumns, dotValues4);
//     if (!dotId3) { return -1; }
//
//     // Insert a record 2
...
//     char* dotValues5[] = {userId, recordId2, recordId2, "60", "Record 2 dot 1", "NOW()", "NOW()", NULL};
...
//     char* dotValues6[] = {userId, recordId3, recordId3, "60", "Record 3 dot 1", "NOW()", "NOW()", NULL};
...
//     char* connectionValues5[] = {"Test Connection", userId, "TRUE", recordId1, recordId3, connectionTypeId2, "NOW()", "NOW()", NULL};
...
//     char* connectionValues1[] = {"Test Connection", userId, "TRUE", recordId3, solutionId2, connectionTypeId, "NOW()", "NOW()", NULL};
//     char* connectionId1 = common_insert("connections", connectionColumns, connectionValues1);
//     if (!connectionId1) { return -1; }
//
...
//     char* connectionValues8[] = {"Test Connection", userId, "TRUE", recordId5, solutionId3, connectionTypeId, "NOW()", "NOW()", NULL};
...
//     char* connectionValues9[] = {"Test Connection", userId, "TRUE", recordId6, solutionId4, connectionTypeId, "NOW()", "NOW()", NULL};
