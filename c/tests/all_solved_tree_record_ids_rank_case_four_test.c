...
int setup_all_solved_tree_record_ids_rank_case_four(void) {
    common_cleanup();
    ...
    // Insert three dots for Record 4
    ...
    char* dotValues7[] = {userId, recordId4, recordId4, "60", "Record 4 dot 2", "NOW()", "NOW()", NULL};
    char* dotId7 = common_insert("dots", dotColumns, dotValues7);
    if (!dotId7) { return -1; }

    char* dotValues8[] = {userId, recordId4, recordId4, "60", "Record 4 dot 3", "NOW()", "NOW()", NULL};
    ...
    char* dotValues9[] = {userId, recordId5, recordId5, "60", "Record 5 dot 1", "NOW()", "NOW()", NULL};
    ...
    char* dotValues10[] = {userId, recordId6, recordId6, "60", "Record 6 dot 1", "NOW()", "NOW()", NULL};
    ...
    char* connectionValues3[] = {"Test Connection betw. record2 and record3", userId, "TRUE", recordId2, recordId3, connectionTypeId2, "NOW()", "NOW()", NULL};
    ...
    char* connectionValues4[] = {"Test Connection betw. record3 and solution1", userId, "TRUE", recordId3, solutionId1, connectionTypeId, "NOW()", "NOW()", NULL};
    ...
    char* connectionValues5[] = {"Test Connection betw. root2 and record4", userId, "TRUE", rootRecordId2, recordId4, connectionTypeId2, "NOW()", "NOW()", NULL};
    ...
    char* connectionValues6[] = {"Test Connection betw. record4 and record5", userId, "TRUE", recordId4, recordId5, connectionTypeId2, "NOW()", "NOW()", NULL};
    ...
    char* connectionValues7[] = {"Test Connection betw. record4 and record6", userId, "TRUE", recordId4, recordId6, connectionTypeId2, "NOW()", "NOW()", NULL};
    ...
    char* connectionValues8[] = {"Test Connection betw. record5 and solution 2", userId, "TRUE", recordId5, solutionId2, connectionTypeId, "NOW()", "NOW()", NULL};
    ...
    char* connectionValues9[] = {"Test Connection betw. record6 and solution 3", userId, "TRUE", recordId6, solutionId3, connectionTypeId, "NOW()", "NOW()", NULL};
...
void test_all_solved_tree_record_ids_rank_case_four(void) {
    setup_all_solved_tree_record_ids_rank_case_four();
    ...
    sprintf(expectedOutput1, "%s: 1 : 0 : 27.000000 : 100.000000 : %s", rootRecordId1, recordId1);
    sprintf(expectedOutput2, "%s: 1 : 0 : 26.400000 : 100.000000 : %s", rootRecordId2, recordId4);
    sprintf(expectedOutput3, "%s: 1 : 0 : 27.000000 : 100.000000 : %s,%s", recordId1, recordId2, rootRecordId1);
    sprintf(expectedOutput4, "%s: 1 : 0 : 27.000000 : 100.000000 : %s,%s,%s", recordId2, recordId3, recordId1, rootRecordId1);
    sprintf(expectedOutput5, "%s: 1 : 0 : 27.000000 : 100.000000 : %s,%s,%s,%s", recordId3, solutionId1, recordId2, recordId1, rootRecordId1);
    sprintf(expectedOutput6, "%s: 1 : 0 : 26.400000 : 100.000000 : %s,%s,%s", recordId4, recordId5, recordId6, rootRecordId2);
    sprintf(expectedOutput7, "%s: 1 : 0 : 26.400000 : 100.000000 : %s,%s,%s", recordId5, solutionId2, recordId4, rootRecordId2);
    sprintf(expectedOutput8, "%s: 1 : 0 : 26.400000 : 100.000000 : %s,%s,%s", recordId6, solutionId3, recordId4, rootRecordId2);
    sprintf(expectedOutput9, "%s: 0 : 1 : 27.000000 : 0.000000 : %s,%s,%s,%s", solutionId1, recordId3, recordId2, recordId1, rootRecordId1);
    sprintf(expectedOutput10, "%s: 0 : 1 : 26.400000 : 0.000000 : %s,%s,%s", solutionId2, recordId5, recordId4, rootRecordId2);
    sprintf(expectedOutput11, "%s: 0 : 1 : 26.400000 : 0.000000 : %s,%s,%s", solutionId3, recordId6, recordId4, rootRecordId2);
